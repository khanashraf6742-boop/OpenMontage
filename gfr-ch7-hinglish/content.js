...
/* ── 4 ─────────────────────────────────────────────────────────── */
{
 ...
 caption: {
 hg:'Rule 213(1) — Fixed assets ka inventory generally site par rakha jaaye; verification kam se kam saal mein ek baar, outcome corresponding register mein darj, aur discrepancies turant investigate karke account mein layi jayen. Rule 213(2) — Sab consumable goods ka physical verification bhi kam se kam saal mein ek baar; discrepancies stock register mein darj kar action ke liye competent authority ko deni hongi. Verification hamesha custodian officer ke saamne ho, aur verification certificate findings ke saath stock register mein record ho. Verification mein mili shortage, damage ya unserviceable goods turant competent authority ke notice mein layi jayen — Rules 33 se 38 ke hisaab se action ke liye.',
 hi:'रूल 213 की सब-रूल (1) — फिक्स्ड assets का इन्वेंटरी आम तौर पर साइट पर रखा जाए। फिक्स्ड assets का वेरिफ़िकेशन कम से कम साल में एक बार हो, और वेरिफ़िकेशन का परिणाम संबंधित रजिस्टर में दर्ज हो। गड़बड़ियाँ हों तो turant जाँच कर उन्हें अकाउंट में लाया जाए। सब-रूल (2) — सब कन्ज़्यूमेबल सामान का फिज़िकल वेरिफ़िकेशन भी कम से कम साल में एक बार हो, और गड़बड़ियाँ स्टॉक रजिस्टर में दर्ज कर action के लिए कॉम्पिटेंट अथॉरिटी को दी जाएँ। वेरिफ़िकेशन हमेशा उस ऑफिसर के सामने हो जिसके पास सामान की कस्टडी है, और वेरिफ़िकेशन सर्टिफिकेट findings के साथ स्टॉक रजिस्टर में दर्ज हो। वेरिफ़िकेशन में पाई गई कमी, नुकसान या अनसर्विसेबल आइटम्स turant कॉम्पिटेंट अथॉरिटी के नोटिस में लाई जाएँ — रूल 33 से 38 के हिसाब से action के लिए।'
 },
 rule: {
 no: 'Rule 213',
 ...
 { label:'Shortage ko record karke turant competent authority ko report karenge — Rules 33 se 38 ke hisaab se action ke liye.', ok:true,
...
/* ── 9 ─────────────────────────────────────────────────────────── */
{
 ...
 why:'Rule 220 ke mutabiq acceptance par <b>kam se kam 25%</b> (yahan ₹20,000) turant mauke par lena hoga, aur balance ke baad hi maal hand over kiya jaata hai.' },

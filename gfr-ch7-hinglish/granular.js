...
/* ══════════════════════ RULE 207 ══════════════════════ */
{
 ...
 ex:'Do baatein: (1) is chapter ke basic rules <b>sab</b> Ministries/Departments par lagte hain; (2) koi bhi Ministry/Department apne detailed instructions aur procedures bana sakta hai — lekin woh <b>"broadly in conformity"</b> hone chahiye, yaani Chapter 7 ke basic rules ke khilaf nahi ja sakte. Matlab ye ki: aapka department apna format, apna timeline aur apni delegation likh sakta hai, par annual verification, GFR-10 report, ₹4 lakh ki line aur write-off sanction jaise basic rules ko hata nahi sakta.' }
 ],
 notes:[],
 provisos:[],
 exceptions:[
 'Autonomous Bodies par GFR tab tak lagta hai jab tak unke bye-laws mein Government-approved alag Financial Rules na hon (Rule 1(3)).',
 'Rule 5 ke under interpretation ka doubt aane par Ministry of Finance ka decision final hota hai.'
 ],
 amendment:null,
 traps:[
...
/* ══════════════════════ RULE 208 ══════════════════════ */
{
 ...
 intro:'Rule 208 mein sirf ek sub-rule hai — <b>Rule 208(1)</b> — jiske andar teen clauses (i), (ii), (iii) hain. Ye tab lagta hai jab maal <b>bahar ke private supplier</b> se aata hai (internal division se aane par Rule 209 lagega).',
 tree:[
 ...
 ex:'Teen physical cheezein <b>har baar</b> honi chahiye: counting, measuring ya weighing, aur <b>visual inspection</b> — aur ye sab <b>receipt ke time par</b> hi. Visual inspection ke teen objective hain: quantity sahi hai, quality specification ke hisaab se hai, aur koi damage/deficiency nahi. <b>Technical inspection</b> "where required" hai — matlab har item par nahi, sirf jahan zaroori ho — aur woh approved Technical Inspector ya approved Agency se hi karwani hogi. Aakhir ka "appropriate receipt ... may also be given" ek <b>MAY</b> hai: supplier ko receipt dena contract provisions par depend karta hai.' },
 ...
 ex:'Do kaam: (1) <b>stock register mein entry</b> — "preferably IT-based", yaani IT system ko tarjeeh hai par ye preference hai, hard mandate nahi; (2) <b>officer-in-charge ka certificate</b> ki usne maal asal mein liya hai aur register mein darj kiya hai. Ye certificate hi receipt ki legal backbone hai.' }
 ],
 notes:[
 ...
 { q:'Rule 208 kis par lagta hai?', a:'Private supplier se milne wale maal par. Internal division se aane wale maal par Rule 209 lagta hai.' }
 ],
...
/* ══════════════════════ RULE 209 ══════════════════════ */
{
 ...
 intro:'Rule 209 mein chaar clauses hain: (i) internal division se maal <b>mangwana</b>, (ii) stock se maal <b>dena</b>, (iii) contractor ko diye gaye maal ki <b>recovery acknowledgement</b>, aur (iv) poora indent <b>pura na kar sakein</b> to kya karna hai — ye last clause sabse zyada ignore hota hai.',
 tree:[
 { l:2, lab:'(i)', tag:'SHALL',
 ...
 notes:[
 'Rule 209 ke (i) mein receipt <b>SHALL</b> hai jabki Rule 208(iii) mein supplier ko receipt dena <b>MAY</b> hai — ye contrast yaad rakhiye.',
...
/* ══════════════════════ RULE 211 ══════════════════════ */
{
 ...
 ex:'Do duties: <b>item-wise lists + accounts</b> rakhna, aur <b>accurate returns</b> banana. Asal test ye hai: <b>kisi bhi waqt</b> asal balance (physical) aur book balance (register) ki tulna ho sake. Register ka format fixed nahi — woh teen cheezon par depend karega: goods ki nature, transactions ki frequency, aur us Ministry/Department ki special requirements. Isliye ek hospital ka drug store register aur ek CPWD store ka register alag dikhte hain — dono valid hain.' },
 { l:2, lab:'(ii)', tag:'SHALL',
...
/* ══════════════════════ RULE 212 ══════════════════════ */
{
 ...
 { q:'Kya Rule 212 hiring-out maana karta hai?', a:'Nahi. Ye allow karta hai, bas record + regular recovery + historical-cost basis ki sharton ke saath.' }
 ],
...
/* ══════════════════════ RULE 213 ══════════════════════ */
{
 ...
 '"At least once in a year" minimum hai — department chahe to zyada baar (jaise half-yearly) karwa sakta hai.'
 ],
 provisos:[],
 exceptions:[
 '"Inventory for fixed assets shall <b>ordinarily</b> be maintained at site" — "ordinarily" exception ka chance rakhta hai (jaise centralized asset register with site-wise sub-records).'
 ],
 amendment:null,
 traps:[
...
/* ══════════════════════ RULE 214 ══════════════════════ */
{
 ...
 hook:'Buffer = authority tay kare · 1 saal se upar = generally surplus',
 intro:'Rule 214 ek chhota rule hai par iska <b>Note</b> poore chapter ka sabse cited line hai — "ek saal se zyada stock mein pada material generally surplus".',
 tree:[
 ...
 amendment:null,
 traps:[
 { q:'Buffer stock ka optimum level kaun tay karta hai?', a:'Competent authority — frequency, quantity aur supply pattern ke base par. GFR koi fixed figure nahi deta.' },
 { q:'1 saal se zyada stock mein pada material automatic surplus hai?', a:'Nahi — "generally" surplus, aur "unless adequate reasons to treat it otherwise exist". Ye rebuttable presumption hai.' },
...
/* ══════════════════════ RULE 215 ══════════════════════ */
{
 ...
 ex:'Teen slabs: <b>≤ 20,000 volumes</b> → har saal complete verification; <b>20,000 se zyada aur 50,000 tak</b> → kam se kam 3 saal mein ek baar complete verification; <b>50,000 se zyada</b> → sample verification, jinke beech ka interval 3 saal se zyada na ho. Aakhir ka line sabse important: agar <b>sample verification mein unusual ya unreasonable shortage</b> dikhe to <b>complete verification</b> karni hi padegi. Matlab sample method chhote library ke liye nahi, bade library ke liye hai — aur jab bhi suspicious nateeja aaye, sample se complete par jaana hi hoga.' },
...
/* ══════════════════════ RULE 216 ══════════════════════ */
{
 ...
 ex:'Teen requirements: (1) jaane wala (transferred) officer ensure karega ki goods/materials <b>sahi tareeke se</b> successor ko hand over ho jayen — sirf chabi dena kaafi nahi; (2) ek <b>statement</b> banega jismein goods/materials ki <b>saari relevant details</b> hon, aur use <b>relieving</b> (charge lene wale) aur <b>relieved</b> (charge chhodne wale) <b>dono</b> officers <b>date ke saath sign</b> karenge; (3) <b>dono ek-ek copy</b> rakhenge. Isi copy se aage chalkar ye tay hota hai ki nayi kami purane officer ki hai ya naye ki.' }
 ],
 notes:[
 'Rule 216 mein koi proviso ya exception nahi — ye har transfer par lagta hai, chahe charge kitne din ka ho.'
 ],
 provisos:[],
 exceptions:[],
 amendment:null,
 ...
 { q:'Kya mukh-zabani (oral) handover valid hai?', a:'Nahi. Rule 216 likhit, date ke saath, dono-signed statement aur copy retention maangta hai.' }
 ],
...
/* ══════════════════════ RULE 217 ══════════════════════ */
{
 ...
 ex:'Committee banana <b>vivek-adhikar</b> hai — "may, at his discretion". Matlab committee <b>zaroori nahi</b>, par bade ya sensitive lots ke liye banana behtar practice (aur aksar departmental instructions mein likha hota hai). Exam mein ye MAY vs SHALL ka favourite sawal hai.' },
 { l:2, lab:'(iii)', tag:'SHALL',
 ...
 ex:'Hazardous waste, scrap batteries aur <b>e-waste</b> ki sale <b>Ministry of Environment & Forest</b> (aaj ke context mein MoEF&CC) ke extant guidelines ke under hogi. Ek aur hard condition: aise lots ke <b>prospective bidders</b> ke paas recycler/pre-processor agency ke roop mein <b>registration</b> hona chahiye jo <b>e-Auction ki date</b> par aur <b>delivery ki date</b> par <b>valid</b> ho. Matlab kisi bhi random scrap dealer ko e-waste bechna maana hai — registered recycler hi kharid sakta hai.' }
 ],
 notes:[
...
/* ══════════════════════ RULE 218 ══════════════════════ */
{
 ...
 provisos:[],
 exceptions:[
 '(iii) hazardous/unfit items — in par threshold lagta nahi, immediate destruction hi rule hai.',
 '(iv) security-sensitive items — official secrets rules ke under alag handling.'
 ],
 amendment:{
 ...
 { q:'Kya threshold "prohibition" hai?', a:'Nahi. Ye <b>mode of disposal</b> tay karta hai, disposal par rok nahi.' }
 ],
...
/* ══════════════════════ RULE 219 ══════════════════════ */
{
 ...
 ex:'Bidders ko bid ke saath <b>bid security</b> deni hogi. Amount <b>generally (ordinarily) assessed ya reserved price ka 10%</b> hoga, aur <b>exact amount bidding document mein likhna</b> hi hoga. "Ordinarily" ka matlab hai ki yahi normal hai, par exact figure document mein declared hona chahiye — bidder ko andaza nahi lagwana chahiye.' },
 ...
 ex:'Agar H1 poori quantity nahi le sakta, to <b>bachi hui quantity</b> agle bidder(s) ko offer ki <b>ja sakti</b> hai — par <b>usi price par jo H1 ne offer kiya tha</b>. Matlab H2 ko H1 ke rate par milega, apne kam rate par nahi. Ye government ke liye price protection hai.' },
 ...
 ex:'Agar selected bidder maal uthane mein interest na dikhaaye (default), to <b>bid security forfeit</b> hogi, aur aage ki action hogi — jismein goods ki <b>re-sale defaulter ke risk and cost par</b> shaamil hai, <b>legal advice lene ke baad</b>. Yani default ka nuksan government ko nahi, defaulter ko jhelna hoga.' },
 ...
 ex:'<b>Late bids</b> — jo specified date/time ke baad aayein — consider <b>nahi</b> kiye jayenge. Ye Rule 202 (non-consulting services) jaisa hi absolute rule hai; koi discretion nahi.' }
 ],
 notes:[
...
/* ══════════════════════ RULE 220 ══════════════════════ */
{
 ...
 ex:'Auction do tareeqe se ho sakti hai: <b>khud (directly)</b> ya <b>approved auctioneers</b> ke through. Dono valid hain — "approved auctioneers" ka matlab hai ki kisi bhi private auctioneer ko nahi, approved ko hi lena hai.' },
 { l:2, lab:'(ii)', tag:'SHALL',
...
/* ══════════════════════ RULE 221 ══════════════════════ */
{
 ...
 intro:'Rule 221 ek paragraph ka hai, par iski <b>pre-condition</b> sabse important hai — ye tabhi lagta hai jab advertised tender <b>aur</b> auction dono try karke dekh liye hon.',
 tree:[
 ...
 { q:'Scrap par bhi na bike to?', a:'Koi bhi dusre mode, including eco-friendly destruction.' }
 ],
...
/* ══════════════════════ RULE 222 ══════════════════════ */
{
 ...
 hook:'Form GFR-11 · Sale supervise karne wale officer ke sign',
 ...
 ex:'Dispose kiye gaye goods ka <b>sale account Form GFR-11</b> mein banega, aur us par <b>us officer ke sign</b> honge jisne sale ya auction ki <b>supervision</b> ki. Dhyan dein: sign karne wala wohi officer hai jisne supervise kiya — koi aur officer "on behalf" sign nahi kar sakta is rule ke under.' }
 ],
 notes:[
 'Rule 222 kisi bhi mode ke baad lagta hai — tender ho, auction ho ya scrap sale.'
 ],
 provisos:[],
 exceptions:[],
 amendment:null,
...
/* ══════════════════════ RULE 223 ══════════════════════ */
{
 ...
 ex:'Teen baatein: (1) <b>revaluation, stock-taking ya kisi aur wajah</b> se hone wale <b>profit aur loss dono</b> record kiye jayenge aur zaroorat padne par adjust kiye jayenge; (2) <b>formal sanction</b> competent authority ki leni hogi — <b>chahe government accounts mein koi correction/adjustment ho ya na ho</b>. Ye aakhri line sabse bada exam trap hai; (3) write-off ki powers <b>DFPR</b> ke under hain — GFR khud koi amount nahi batata.' },
 ...
 ex:'Depreciation se hone wale loss ko <b>chaar heads</b> mein baant kar record karna hai: (i) market price ka normal utaar-chadhav; (ii) normal ghisavat (wear & tear); (iii) kharid regulate karne mein foresight ki kami; (iv) kharid ke baad negligence. Dhyan dein — (iii) aur (iv) "normal" nahi hain, ye management failures hain, isliye inhein alag head mein dikhana accountability ka hissa hai.' },
 ...
 provisos:[],
 exceptions:[
 'Force Majeure (aag, baadh, enemy action) — ye head batata hai ki har loss mein kisi ki negligence nahi hoti.'
 ],
 amendment:null,
 traps:[
 { q:'Accounts mein koi adjustment nahi hoga to bhi sanction chahiye?', a:'Haan — Rule 223(1) clear roop se kehta hai "even though no formal correction or adjustment in government accounts is involved".' },
...
const QUIZ_EXTRA = [
 ...
 e:'Rule 208(1)(ii): sab materials ko counted/measured/weighed karne ke saath <b>visual inspection</b> zaroori hai. Technical inspection "where required" hai.' },
